...
import { CheckCircle, Clock, Users, Video, ArrowLeft, Star, Shield, Zap } from "lucide-react";
  ...
  const benefits = [
    {
      ...
      description: "High-quality video edits that engage customers"
    },
    {
      icon: Star,
      title: "Brand Consistency",
      description: "Maintains your brand identity throughout the video"
    },
    {
      icon: Shield,
      title: "Amazon Optimized",
      description: "Videos optimized for Amazon's platform requirements"
    }
  ];
